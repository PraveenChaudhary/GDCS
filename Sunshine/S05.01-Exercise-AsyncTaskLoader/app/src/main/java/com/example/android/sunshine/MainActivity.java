...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocationBundle = new Bundle();
        mLocation = SunshinePreferences.getPreferredWeatherLocation(this);
        mLocationBundle.putString(LOCATION_KEY, mLocation);
        getSupportLoaderManager().initLoader(LOADER_ID, mLocationBundle, this);
    }
    ...
    private void loadWeatherData() {
        ...
        if (loader == null) {
            loaderManager.initLoader(LOADER_ID, mLocationBundle, this);
        } else {
            loaderManager.restartLoader(LOADER_ID, mLocationBundle, this);
        }
    }
