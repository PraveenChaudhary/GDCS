...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void loadColorFromSharedPreferences(SharedPreferences sharedPreferences) {
        mVisualizerView.setColor(sharedPreferences.getString(getString(R.string.pref_change_color_key), getString(R.string.pref_color_default_value)));
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        } else if (key.equals(getString(R.string.pref_change_color_key))) {
            loadColorFromSharedPreferences(sharedPreferences);
        }
