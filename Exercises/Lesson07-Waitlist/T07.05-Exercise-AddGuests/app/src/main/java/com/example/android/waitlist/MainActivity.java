...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText mNewartySizeEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNewartySizeEditText = (EditText) findViewById(R.id.party_count_edit_text);
    ...
    public void addToWaitlist(View view) {
        ...
        String partySize = mNewartySizeEditText.getText().toString();
        if (personName.equals("") || partySize.equals("")) {
            Toast.makeText(this, "Please both fields, person name and party size ", Toast.LENGTH_LONG).show();
        }
        ...
        mNewartySizeEditText.getText().clear();
        mNewartySizeEditText.clearFocus();
    ...
    private long addGuest(String personName, int partySize) {
        ContentValues cv = new ContentValues();
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME, personName);
